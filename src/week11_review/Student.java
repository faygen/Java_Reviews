...
public class Student extends Person{
    ...
    public void study(){
        System.out.println(getName() + " is studying");//getName () private cunku
    }

    @Override
    public String toString() {
        return getClass().getSimpleName()+"{" + //student sildik getclass ve super ekledik
                super.toString() +//super.toString() ekle parent class dan almak icin
                ", studentId='" + studentId + '\'' +
